...
// @ts-ignore
const WalletAddressBookTable = ({ mockData }) => {
            ...
            page.map((row: any) => {
              ...
              return (
                <tr {...row.getRowProps()}>
                  ...
                  <td {...row.cells[3].getCellProps()}>{row.cells[3].render("Cell")}
                    <CustomImage
                      image="/assets/images/icons/copy.svg"
                      cursor="pointer"
                      onClick={() => {
                        handleCopyToClipboard(row.cells[3])
                        successAlert("Copied!!")
                      }}
                    />
                  </td>
...
export default WalletAddressBookTable;